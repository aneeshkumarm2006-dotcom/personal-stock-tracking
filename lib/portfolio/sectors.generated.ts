...
// Source: NSE Nifty-500 constituent list (scanner/data/snapshots/<date>/ind_nifty500list.csv).
// Regenerate with the generator in the plan when the list changes.
// Keys are normalized symbols (uppercased, '&' -> '_') to match normalize() in sectors.ts.
// Values are NSE's macro "Industry" classification, used as the stock's sector.

export const GENERATED_SECTOR_MAP: Record<string, string> = {
  ...
  "ARE_M": "Automobile and Auto Components",
  ...
  "M_M": "Automobile and Auto Components",
